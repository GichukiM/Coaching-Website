    ...
    <div className="w-full pt-8 bg-white dark:bg-gray-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 dark:border-gray-700">
        <figure className="flex flex-col items-center justify-center p-4 text-center bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          <a href="#" id="S-buttons" className="mt-4 inline-block px-6 py-3 text-gray-950 border duration-300">Book a Session</a>
        </figure>
        ...
        <figure className="flex flex-col items-center justify-center p-4 text-center bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          <a href="#" id="S-buttons" className="mt-4 inline-block px-6 py-3 text-gray-950 border duration-300">Join a Workshop</a>
        </figure>
        ...
        <figure className="flex flex-col items-center justify-center p-4 text-center bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          <a href="#" id="S-buttons" className="mt-4 inline-block px-6 py-3 text-gray-950 border duration-300">Schedule a Consultation</a>
        </figure>
        ...
        <figure className="flex flex-col items-center justify-center p-4 text-center bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          <a href="#" id="S-buttons" className="mt-4 inline-block px-6 py-3 text-gray-950 border duration-300">Explore Programs</a>
        </figure>
      </div>
    </div>
  );
